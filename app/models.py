...
class Lesson(db.Model):
    ...
    assets = db.relationship('LessonAsset', backref='lesson', lazy='dynamic', cascade='all, delete-orphan')
...
class Hint(db.Model):
    ...
    penalty_points = db.Column(db.Integer, default=5)
    created_at = db.Column(db.DateTime, default=datetime.utcnow)
...
class UserProgress(db.Model):
    ...
    max_quiz_score = db.Column(db.Integer, default=0)
...
class Attempt(db.Model):
    ...
    expected_command = db.Column(db.Text)
